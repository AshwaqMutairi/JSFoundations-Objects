...
function channelHasVideo(videoTitle, channel) {
  ...
  //and i asked to some inside the videos array inside the chanel that's
  //givven, and then gived the some the condition to check it
}
...
function getChannelByName(channelName, channels) {
  ...
  //find will return the channel object
}
